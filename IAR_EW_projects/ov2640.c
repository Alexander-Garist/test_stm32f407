  ...
  case CAMERA_BLACK_WHITE:
    {
      switch(value)
      {
		case CAMERA_BLACK_WHITE_BW:				ret =  OV2640_BLACK_WHITE_BW;			break;
		case CAMERA_BLACK_WHITE_NEGATIVE:		ret =  OV2640_BLACK_WHITE_NEGATIVE;		break;
		case CAMERA_BLACK_WHITE_BW_NEGATIVE:	ret =  OV2640_BLACK_WHITE_BW_NEGATIVE;	break;
		case CAMERA_BLACK_WHITE_NORMAL:			ret =  OV2640_BLACK_WHITE_NORMAL;		break;
		default:								ret =  OV2640_BLACK_WHITE_NORMAL;		break;
      }
      break;
    }
  case CAMERA_CONTRAST_BRIGHTNESS:
    {
      switch(value)
      {
		case CAMERA_BRIGHTNESS_LEVEL0:	ret =  OV2640_BRIGHTNESS_LEVEL0;	break;
		case CAMERA_BRIGHTNESS_LEVEL1:	ret =  OV2640_BRIGHTNESS_LEVEL1;	break;
		case CAMERA_BRIGHTNESS_LEVEL2:	ret =  OV2640_BRIGHTNESS_LEVEL2;	break;
		case CAMERA_BRIGHTNESS_LEVEL3:	ret =  OV2640_BRIGHTNESS_LEVEL3;	break;
		case CAMERA_BRIGHTNESS_LEVEL4:	ret =  OV2640_BRIGHTNESS_LEVEL4;	break;
		case CAMERA_CONTRAST_LEVEL0:	ret =  OV2640_CONTRAST_LEVEL0;		break;
		case CAMERA_CONTRAST_LEVEL1:	ret =  OV2640_CONTRAST_LEVEL1;		break;
		case CAMERA_CONTRAST_LEVEL2:	ret =  OV2640_CONTRAST_LEVEL2;		break;
		case CAMERA_CONTRAST_LEVEL3:	ret =  OV2640_CONTRAST_LEVEL3;		break;
		case CAMERA_CONTRAST_LEVEL4:	ret =  OV2640_CONTRAST_LEVEL4;		break;
		default:						ret =  OV2640_CONTRAST_LEVEL0;		break;
      }
      break;
    }
  case CAMERA_COLOR_EFFECT:
    {
      switch(value)
      {
		case CAMERA_COLOR_EFFECT_ANTIQUE:	ret =  OV2640_COLOR_EFFECT_ANTIQUE;	break;
		case CAMERA_COLOR_EFFECT_BLUE:		ret =  OV2640_COLOR_EFFECT_BLUE;	break;
		case CAMERA_COLOR_EFFECT_GREEN:		ret =  OV2640_COLOR_EFFECT_GREEN;	break;
		case CAMERA_COLOR_EFFECT_RED:		ret =  OV2640_COLOR_EFFECT_RED;		break;
		default:							ret =  OV2640_COLOR_EFFECT_RED;		break;
      }
      break;
    default:	ret = 0;	break;
    }
...
void ov2640_Config(uint16_t DeviceAddr, uint32_t feature, uint32_t value, uint32_t brightness_value)
{
  ...
  case CAMERA_CONTRAST_BRIGHTNESS:
    {
      value1 = (uint8_t)(value_tmp);						// младший 0х28
      value2 = (uint8_t)(value_tmp >> 8);					// старший 0хС2
      CAMERA_IO_Write(DeviceAddr, 0xff, 0x00);
      CAMERA_IO_Write(DeviceAddr, 0x7c, 0x00);
      CAMERA_IO_Write(DeviceAddr, 0x7d, 0x04);
      CAMERA_IO_Write(DeviceAddr, 0x7c, 0x07);
      CAMERA_IO_Write(DeviceAddr, 0x7d, br_value);			// 0х20
