...
/**********************************************************************************************************************/
    ...
    while(1)
    {
        ...
        if (camera_restart || frame_counter == 20)
        {
            ov2640_Reset();
            ov2640_Read_ID(0x30);
            ov2640_Init(0x30);
